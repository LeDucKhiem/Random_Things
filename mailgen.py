...
if __name__ == "__main__":
    ...
    parser.add_argument("input_file", help="Path to input file containing usernames")
    parser.add_argument("output_file", help="Path to output file for modified usernames")
    parser.add_argument("domain", help="Domain name to append (e.g., example.com)")
